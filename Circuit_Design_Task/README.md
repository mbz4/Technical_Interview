...
Powering: Power the SS94A1 with the MCU's Vcc. This ensures the ratiometric behavior is based on the MCU's Vcc.
...
Remember, the above are high-level suggestions. When implementing them, you'd have to consider detailed component ratings, layout considerations, and more based on the exact application and requirements.